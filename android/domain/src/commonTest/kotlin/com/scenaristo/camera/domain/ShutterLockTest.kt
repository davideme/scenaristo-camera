 ...
 *
 * The ISO lock that once sat beside it was dropped before it shipped (Davide,
 * 2026-09-06): two automatic responsiveness modes replace it. The shutter lock
 * stays, because it pins a *rung* of the flicker-safe ladder — the one thing the
 * ladder cannot infer from the scene, since both rungs are correct exposures and
 * only the user knows whether they want the motion blur.
 */
