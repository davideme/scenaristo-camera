...
| [0028](0028-portrait-lighting-read.md) | Read the key ratio, background separation and room light from the frames already being metered; report only, and not during a take | Proposed | 6.3, 6.11 |
| [0029](0029-studio-look-at-1080p-with-ml-kit.md) | A studio look is a 1080p mode built on `ImageAnalysis` and ML Kit; 4K keeps everything it has | Proposed | 3, 6.1, 6.11 |
